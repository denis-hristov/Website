...
const blocks = [
  ...
  { title: "My 5-Year Vision", img: "/resurses/Aspire 2.jpg", text: ["I strive to keep growing and to inspire the people around me to do the same. I believe motivation and ambition are key to success, yet they’re often missing in the younger generation.","That’s why I want to lead by example and show that with the right knowledge, consistency, and effort, anything is possible."], reverse:true },
  { title: "The Business I’m Building", img: "/resurses/Aspire 3.jpg", text: ["Motivational content to help you make progress and keep going.", "Personal Archetype Questionnaire. Understand yourself and get personalized advice to improve.", "Gym app to track workouts, calories, and body stats.",], button:"Try the Gym app", href:"https://denis-fitplanner-pro.web.app/" },
